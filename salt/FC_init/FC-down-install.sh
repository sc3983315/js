...
wget -SO /usr/local/squid/etc/squid.conf http://111.1.32.153:/huanw/shencan/FC7/squid.conf.down
...
wget -SO /usr/local/squid/etc/squid.conf http://111.1.32.153:/huanw/shencan/FC7/squid.conf.386.down
wget -SO - http://111.1.32.153:/huanw/shencan/FDNS_for_FCv1.0.6.sh |bash
sed -i "s/CMN-NJ-L-3O3/$host/g"  /usr/local/squid/etc/squid.conf 
fi
wget -SO /usr/local/squid/bin/storeurl_update2.pl http://111.1.32.153:/huanw/shencan/FC7/storeurl_update2.pl 
chown squid.squid /usr/local/squid/bin/storeurl_update2.pl  && chmod +x  /usr/local/squid/bin/storeurl_update2.pl
